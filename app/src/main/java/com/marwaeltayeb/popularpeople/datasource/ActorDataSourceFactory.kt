...
class ActorDataSourceFactory(private val scope: CoroutineScope, private val actorService : ActorService): DataSource.Factory<Int, Actor>() {
    ...
    override fun create(): DataSource<Int, Actor> {
        ...
        val actorDataSource = ActorDataSource(scope, actorService)
