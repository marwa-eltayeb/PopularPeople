...
class ActorDataSource : PageKeyedDataSource<Int, Acting>() {

    override fun loadInitial(params: LoadInitialParams<Int>, callback: LoadInitialCallback<Int, Acting>) {
        RetrofitClient.getActingService().getActorsList(Const.API_KEY, Const.LANGUAGE, Const.FIRST_PAGE)
    ...
    override fun loadBefore(params: LoadParams<Int>, callback: LoadCallback<Int, Acting>) {
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, Acting>) {
